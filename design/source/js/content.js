    ...
    hoiio += "  <div class=\"hoiio-logo column\">";
    hoiio += "      <a href=\"\/design\"><i class=\"icon compass\"><\/i><\/a>";
    hoiio += "  <\/div>";
    hoiio += "  <div class=\"hoiio-heading column\">";
    hoiio += "  <a href=\"\/design\">Design Standards<\/a>";
    hoiio += "<\/div>";
    hoiio += "<\/div>";
    hoiio += "<div class=\"ui middle aligned grid\">";
    ...
    hoiio += "    <li id='intro' class=\"item\"><a href=\"\/design\">Introduction<\/a><\/li>";
    ...
    hoiio += "    <li class=\"item\"><a href=\"\/design\/component\/segment\">Segment<\/a><\/li>";
    ...
    hoiio += "    <li class=\"item line through\"><a href=\"\/design\/plugin\/dimmer\">Dimmer<\/a><\/li>";
    hoiio += "    <li class=\"item line through\"><a href=\"\/design\/plugin\/dropdown\">Dropdown<\/a><\/li>";
    hoiio += "    <li class=\"item\"><a href=\"\/design\/plugin\/modal\">Modal<\/a><\/li>";
    hoiio += "    <li class=\"item line through\"><a href=\"\/design\/plugin\/popup\">Popup<\/a><\/li>";
hoiio += "    <li class=\"item line through\"><a href=\"\/design\/component\/progress\">Progress<\/a><\/li>";
    hoiio += "    <li class=\"item line through\"><a href=\"\/design\/plugin\/search\">Search<\/a><\/li>";
    hoiio += "    <li class=\"item line through\"><a href=\"\/design\/plugin\/sidebar\">Sidebar<\/a><\/li>";
    hoiio += "    <li class=\"item line through\"><a href=\"\/design\/plugin\/tab\">Tab<\/a><\/li>";
    hoiio += "<\/ul>";
    hoiio += "<\/nav>";
    hoiio += "<\/div>";
    hoiio += "<\/div>";
